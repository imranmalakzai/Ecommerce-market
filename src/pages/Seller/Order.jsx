...
import {assets, dummyOrders} from "../../Assets/images/assets.js"
...
function Order() {
  ...
  useEffect(() => {
    ...
    return (
       <div className='no-scrollbar flex-h h-[90vh] overflow-y-scroll flex flex-col justify-between'>
            ...
            {orders.map((order, index) => (
                <div key={index} className="flex flex-col md:grid md:grid-cols-[2fr_1fr_1fr_1fr] md:items-center gap-5 p-5 max-w-4xl rounded-md border border-gray-300 text-gray-800">
                    ...
                    <div className="text-sm">
                        <p className='text-sm md:text-base text-black/60'>{order.address.firstName} {order.address.lastName}</p>
                        <p className='text-black/80'>{order.address.street}, {order.address.city},
                        </p>
                        <p>
